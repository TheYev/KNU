...
teachers = [
    Teacher("Krak", 7, ["english", "history"]),
    Teacher("Chernega", 7, ["english", "history", "arts"]),
    Teacher("Pashko", 5, ["math", "science"]),
    Teacher("Svistunov", 11, ["arts", "literature"]),
    Teacher("Koval", 7, ["literature"]),
    Teacher("Zolotarev", 8, ["english"]),
    Teacher("Shishatska", 4, ["math", "science"]),
    Teacher("Anikushin", 14, ["math"]),
    Teacher("Panchenko", 4, ["science"]),
]
